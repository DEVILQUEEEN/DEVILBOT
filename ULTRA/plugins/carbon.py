# arre bhaiya, ruko zara, sabr kro
# kang krne se pehle credit to padh lo
...
async def carbon_api(e):
    ...
    madboy = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await madboy.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await madboy.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await madboy.edit("`Uploading..`")
...
async def carbon_api(e):
    madboy = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await madboy.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = CHROME_BIN
...
async def carbon_api(e):
    ...
    await madboy.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await madboy.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await madboy.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await madboy.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await madboy.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await madboy.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await madboy.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await madboy.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await madboy.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await madboy.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await madboy.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await madboy.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
