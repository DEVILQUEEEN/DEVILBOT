...
from DEVILBOT import HEROKU_APP_NAME, HEROKU_API_KEY
...
async def inline_id_handler(event: events.InlineQuery.Event):
    ...
    if not event.query.user_id == me.id:
        resultm = builder.article(title="Me iz not your Bot",description="Mind Your Own Bizness",text="Hey!! U Must Use https://github.com/DEVILBOT-OP/DEVILBOT-X",buttons=[[Button.switch_inline("Search Again", query="logs", same_peer=True)],], )
