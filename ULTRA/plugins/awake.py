...
from DEVILBOT import ALIVE_NAME, StartTime, CMD_HELP
#from . import legend
from DEVILBOTX import BOT, PHOTO, VERSION
...
#     ALIVE_MESSAGE += f"✧ 𝚄𝙿𝚃𝙸𝙼𝙴 : {uptm}\n\n"
     ...
     ALIVE_MESSAGE += "✧ 𝙶𝚁𝙾𝚄𝙿 : [SUPPORT](https://t.me/DEVILBOTXOT)\n\n"
     ALIVE_MESSAGE += f"✧ [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU&template=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2HEROKU) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/DEVILBOT-OP/DEVILBOT-X) ✧\n"   
     await awake.delete() 
...
#     ALIVE_MESSAGE += f"✧ 𝚄𝙿𝚃𝙸𝙼𝙴 : {uptm}\n\n"
     ...
     ALIVE_MESSAGE += f"✧ [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU&template=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/DEVILBOT-OP/DEVILBOT-X) ✧\n"   
     await awake.delete() 
     await borg.send_file(awake.chat_id, PHOTO,caption=ALIVE_MESSAGE)
   else:
