...
import re, os
from DEVILBOTX import PHOTO, xbot, BOT, VERSION
from DEVILBOT import bot
...
async def awake(event):
  ...
  BUTTON = [[Button.url("Mᴀsᴛᴇʀ", f"https://t.me/{bot.me.username}"), Button.url(f"{BOT} Rᴇᴘᴏ", "https://github.com/DEVILBOT-OP/DEVILBOT-X")]]
...
# inline by LEGENDX22 and PROBOY22 🔥
  PROBOYX = [[Button.url("Rᴇᴘᴏ UʟᴛʀᴀX", "https://github.com/DEVILBOT-OP/DEVILBOT-X")]]
  PROBOYX +=[[Button.url("Dᴇᴘʟᴏʏ UʟᴛʀᴀX", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU&template=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU")]]
  PROBOYX +=[[Button.url("Tᴜᴛᴏʀɪᴀʟ", "https://youtu.be/rGCSSFPsS4Q"), Button.url("Sᴛʀɪɴɢ Sᴇssɪᴏɴ", "https://replit.com/@legendx22/DEVILBOT-X#main.py")]]
...
# inline by LEGENDX22 and PROBOY22 🔥
  ...
  LEGENDX += "**Tᴇʟᴇᴛʜᴏɴ** : `1.20`\n\n"
  LEGENDX += "~~ **Tʜᴀɴᴋs ғᴏʀ ᴄʜᴇᴄᴋɪɴɢ ᴍᴇ** !!"
  BUTTONS = [[Button.url("Mᴀsᴛᴇʀ", f"https://t.me/{bot.me.username}"), Button.url(f"{BOT} Rᴇᴘᴏ", "https://github.com/DEVILBOT-OP/DEVILBOT-X")]]
...
async def repo(event):
  await xbot.send_message(event.chat, "**Hᴇʀᴇ Is Tʜᴇ Rᴇᴘᴏ Fᴏʀ υℓтяα χ Usᴇʀʙᴏᴛ** \n\nFᴏʀ Aɴʏ Hᴇʟᴘ :- @UltraXOT", buttons=[[Button.url("⚜️ Rᴇᴘᴏ ⚜️", "https://github.com/DEVILBOT-OP/DEVILBOT-X"), Button.url("🔰 Dᴇᴘʟᴏʏ 🔰", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU&template=https%3A%2F%2Fgithub.com%2FDEVILBOT-OP%2FHEROKU")]])
