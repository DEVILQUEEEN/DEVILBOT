...
import os
import re
from DEVILBOTX import PHOTO, ID as id
from telethon import Button, custom, events, functions
import telethon
from telethon.tl.functions.users import GetFullUserRequest
from telethon.utils import pack_bot_file_id
from DEVILBOT.uniborgConfig import Config
from DEVILBOTX import xbot, devs as DEVS
from DEVILBOT import bot
from DEVILBOT.plugins.sql_helper.blacklist_ass import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)

from DEVILBOT.plugins.sql_helper.bot_users_sql import add_me_in_db, his_userid
from DEVILBOT.plugins.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def start(event):
    ...
    if event.sender_id == boy:
        ...
        await xbot.send_file(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.url("Dᴇᴘʟᴏʏ Yᴏᴜʀ Oᴡɴ UʟᴛʀᴀX", "http://GitHub.com/DEVILBOT-OP/DEVILBOT-X")],
